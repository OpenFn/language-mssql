    ...
    try {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var structureData = data.map(function (x) {
          return "".concat(x.name, " ").concat(x.type, " ").concat(x["default"] ? "DEFAULT '".concat(x["default"], "'") : '', " ").concat(x.unique ? 'UNIQUE' : '', " ").concat(x.identity ? 'PRIMARY KEY IDENTITY (1,1)' : '', " ").concat(x.required ? 'NOT NULL' : '');
        }).join(', ');
  ...
  return function (state) {
    ...
    try {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var structureData = data.map(function (x) {
          return "".concat(x.name, " ").concat(x.type, " ").concat(x["default"] ? "DEFAULT '".concat(x["default"], "'") : '', " ").concat(x.unique ? 'UNIQUE' : '', " ").concat(x.identity ? 'IDENTITY (1,1)' : '', " ").concat(x.required ? 'NOT NULL' : '');
        }).join(', ');
